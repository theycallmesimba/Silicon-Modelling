function sparams = createOriginHOs( sparams, X, Y )
...
%   Detailed explanation goes here
    ...
    sparams.originHOs(sparams.nOriginHOs) = twoDimNonShiftHO;
    ...
    for ii = 0:(sparams.maxOriginHOsX-1)
        ...
        for jj = 0:(sparams.maxOriginHOsY-1)
            ...
            kk = kk + 1;
            sparams.originHOs(kk).initialize(WFMG,convertMGtoNO(WFMG),ii,jj,eXTemp+eYTemp);
