function [sparams] = solveLOHOToOriginCoeffs(sparams, X, Y)
%SOLVELOHOTOORIGINCOEFFS Summary of this function goes here
%   Detailed explanation goes here
    ...
    for jj = 1:sparams.nOriginHOs
        ...
        for ii = 1:sparams.nSingleOrbitals
            ...
            shiftedMG = sparams.LOHOs(ii).wavefunctionMG;
