function saveGIFofEvolution(sparams, fig, currTime)
%SAVEGIFOFEVOLUTION Summary of this function goes here
%   Detailed explanation goes here

    [A,map] = rgb2ind(frame2im(getframe(fig)),256);
    fullFnameGIF = [sparams.saveDir sparams.saveFolder num2str(sparams.totalTime(jj))...
    ...
    fullNameJPEG = [sparams.saveDir sparams.saveFolder num2str(sparams.totalTime(jj))...
